/* This program uses enum and struct types to print
specific dates and the following of each date*/
...
//Function that prints a specific date and knows how many days are in each month
void printday(date* dt) //dt is an abbreviation for date
{
...
// Function that passes the date to the following day
...
int main()
{
    ...
    date date4 = {oct, 31};
    date date5 = {dec, 31};
    date dates[] = {date1, date2, date3, date4, date5}; //Array with all the dates the assignment asks for

    //Print each date and the following day
    for (i=0; i<5; i++)
    {
        printf("Date is ");
        printday(&dates[i]);
